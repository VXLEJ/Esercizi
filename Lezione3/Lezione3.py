...
Pizzas: list = ['Margherita','Crostino','Patatine fritte e Wurstel']
for Pizza in Pizzas:
    print(Pizza)
...
#gatto = 'Felino feroce'
#criceto = 'ottimo per i bambini'
#descanimals: dict = {cane,gatto,criceto}

#Animals: dict = {'Cane','Gatto','Criceto'}
#for Animal,desc in Animals:
#    for descs in descanimals:
#        print('Animal + {}'.format(descs))
#
...
Cubes: list = {1*3,2*3,3*3,4*3,5*3,6*3,7*3,8*3,9*3,10*3}
print(Cubes)

print('\n new exercise \n')
#4-9. Cube Comprehension: Use a list comprehension to generate a list of the first 10 cubes.
Cubes: list = [i**3 for i in range(11)]
print(Cubes)
...
print('first three items: ',Cubes[1:4])
print('three items in the middle: ',Cubes[4:7])
print('last three items: ',Cubes[8:])
...
friend_pizzas: list = ['Margherita','Crostino','Patatine fritte e Wurstel']
